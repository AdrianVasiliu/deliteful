 ...
 * the required channel. The flags are uniquely based on the screen size:
 *
 ...
 * 
 * The values of the flags are set using the media query feature `max-width: <breakpointSize>`.
 * The default values for `breakpointSize`for each channel are the following:
...
define(["dcl/dcl", "requirejs-dplugins/has", "module", "decor/Evented"],
	...
	var breakpoints =
		...
		// ResponsiveColumns: 
		{small: "480px", medium: "1024px", large: ""};
		// Bootstrap:
